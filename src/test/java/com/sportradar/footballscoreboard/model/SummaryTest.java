...
public class SummaryTest {
    ...
    public void of_shouldCreateProperSummary() {
        ...
        Match match_1 = Match.newMatch(homeTeam_1, awayTeam_1).updateScore(NewScore.of(1, 1));
        Team homeTeam_2 = Team.of("japan");
        Team awayTeam_2 = Team.of("usa");
        Match match_2 = Match.newMatch(homeTeam_2, awayTeam_2).updateScore(NewScore.of(2, 3));
        ...
        assertThat(summary_1.getHomeTeamSummary().getScore().getScore()).isEqualTo(1);
        assertThat(summary_1.getAwayTeamSummary().getTeam()).isEqualTo(awayTeam_1);
        assertThat(summary_1.getAwayTeamSummary().getScore().getScore()).isEqualTo(1);
        ...
        assertThat(summary_2.getHomeTeamSummary().getScore().getScore()).isEqualTo(2);
        assertThat(summary_2.getAwayTeamSummary().getTeam()).isEqualTo(awayTeam_2);
        assertThat(summary_2.getAwayTeamSummary().getScore().getScore()).isEqualTo(3);
    }
}